            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                {items.map((item) => {
                    ...
                    return (
                        <article
                            key={item.id}
                            className="group rounded-xl border border-violet-100 bg-violet-50 p-5 transition duration-300 hover:bg-violet-100 hover:shadow-md"
                        >
                            <Icon className="mb-3 h-6 w-6 text-slate-500 transition duration-300 group-hover:text-[#7C3AED]" />
